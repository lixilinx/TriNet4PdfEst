...
Ws_encoder = U.fnn_init([2, 256, 256, 256, 2], device)
Ws_decoder = U.fnn_init([2, 1024, 1024, 1024, 2], device)
...
for bi in range(num_iter):
    ...
    v_gauss, nll = U.encoding_fnn(x, Ws_encoder, return_nll=True)
...
plt.savefig('why_it_works_demo.png')